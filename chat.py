...
if question:
    if not st.session_state["news_links"]:
        ...
        if answer.lower() == "yes":
            ...
            final_prompt = f"Each link represents a news article. Respond with the summary of the article text of the link that the question is referring to. Use the whole article text of the link that the question is referring to for sentiment. Question: {question} links: {links}"
        else:
