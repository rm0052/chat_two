...
if question:
    if not st.session_state["news_links"]:
        ...
        if answer.lower() == "yes":
            ...
            final_prompt = f"Each link represents a news article. Respond with the summary of the article text of the link that the question is referring to. In case of conflict, use the links provided as the main source of information. Question: {question} links: {links}"
        else:
